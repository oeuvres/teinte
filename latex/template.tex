...
\documentclass[11pt,twoside,french,dvipsnames]{book}
...
\colorlet{borderline}{BrickRed!30!}
...
\ifxetex
  ...
  \setmainfont[%
    ...
    % UprightFont={* Light}, % emph in emph
...
\newcommand{\astermono}{\medskip\centerline{\color{BrickRed}\large\selectfont{\syms ✻}}\medskip\par}%
\newcommand{\astertri}{\bigskip\centerline{\color{BrickRed}\large\selectfont{\syms ✻\,✻\,✻}\medskip\par}}%
\newcommand{\asterism}{\bigskip\par\noindent\parbox{\linewidth}{\centering\color{BrickRed}\large{\syms ✻}\\{\syms ✻}\hskip 0.75em{\syms ✻}}\bigskip\par}%
\usepackage{enumitem}
\setlist{noitemsep,wide,leftmargin=*, labelindent=0pt} % labelindent=\parindent,leftmargin=*
\setlist[itemize]{label=—}

% TEI commands
% be careful of environment in environment (ex: div/quote/bibl)
\def\abbr{}
...
\renewcommand\subsection{\@startsection{subsection}{2}{\z@}%
  {-1.75ex\@plus -0.5ex \@minus- .2ex}%
  {0.5ex \@plus .2ex}%
  {\reset@font\Large\color{BrickRed}}
}
...
\titleformat
  {name=\chapter}
  [display]
  {\huge\bfseries\raggedleft\color{BrickRed}}
  {}
  {0pt}
...
\newtcolorbox{sectionbox}{%
  ...
  bottom=0pt,
  halign=flush right,
  lifted shadow={-0.5pt}{-2mm}{3mm}{0.1mm}{BrickRed}
}
...
\renewcommand{\headrule}{\color{BrickRed}\oldheadrule}% Add colour to \he
% redefine plain
